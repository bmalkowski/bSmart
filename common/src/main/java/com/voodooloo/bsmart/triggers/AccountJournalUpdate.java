...
public class AccountJournalUpdate implements Trigger {
    @Override
    ...
    public void fire(Connection conn, Object[] oldRow, Object[] newRow) throws SQLException {
        ...
        Record1<BigDecimal> sumRecord = context.select(sum(ACCOUNT_JOURNAL.QUANTITY))
                                               .from(ACCOUNT_JOURNAL)
                                               .where(ACCOUNT_JOURNAL.ACCOUNT_ID.equal(accountId))
                                               .fetchOne();
